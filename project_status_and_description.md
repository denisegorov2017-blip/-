...
| **🧠 Модель** | **Механизм обратной связи по инвентаризации `(новое)`** | Создать стандартизированный шаблон (Excel/CSV) для ввода фактических результатов инвентаризации. Система сможет использовать эти файлы для автоматического дообучения модели, замыкая цикл "Прогноз -> Реальность -> Обучение". | **Высокий** |
