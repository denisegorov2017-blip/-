...
# -*- coding: utf-8 -*-
"""
Пример использования базы данных системы расчета коэффициентов усушки.

Этот скрипт демонстрирует основные возможности работы с базой данных,
включая сохранение данных, загрузку исторических данных и выполнение аналитических запросов.
"""
...
try:
    ...
    from src.core.database.utils import (
        ...
        get_database_info, create_database_backup
    )
except ImportError:
...
def main():
    ...
    print("=== Пример использования базы данных системы расчета коэффициентов усушки ===\n")
    ...
    try:
        ...
        print("2. Тестирование подключения к базе данных...")
        ...
        source_data = db_service.create_source_data(
            file_name="инвентаризация_2023.xlsx",
            file_path="исходные_данные/инвентаризация_2023.xlsx",
        ...
        print("8. Создание резервной копии базы данных...")
        ...
        # 9. Финальная информация о базе данных
        print("9. Финальная информация о базе данных...")
