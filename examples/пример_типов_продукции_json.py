...
Сохраняет результаты в формате JSON вместо CSV
"""
...
def main():
    ...
    for nomenclature, initial_weight, product_type_desc in product_examples:
        ...
        results.append({
            ...
            "Начальный вес": initial_weight,
            "Процент усушки": shrinkage_percentage
        })
    ...
    json_path = os.path.join(results_dir, "пример_типов_продукции.json")
    
    # Подготавливаем данные для сохранения
    output_data = {
        "Дата расчета": "2025-08-27",
        "Период хранения (дней)": 7,
        "Результаты": results
    }
